...
# filpaths
base_dir = '/Users/mackenzie/Desktop/gdpyt-characterization/figure data/intrinsic-aberrations-defocusing/' \
           '11.06.21_z-micrometer-v2/FINAL-04.25.22_SPCT_1um-calib_5um-test'
...
remove_ids = dfcounts[dfcounts['z_corr'] < dfcounts.z_corr.max() * 0.9].id.unique()
