...
# run
base_dir = '/Users/mackenzie/Desktop/gdpyt-characterization/datasets/synthetic_overlap_noise-level2/single'
base_results = base_dir + '/results'
image_path = base_dir + '/xy37.5/test_images'
filetype = '.tif'
savetype = '.png'
split_strings = ('calib_', '.tif')
sort_strings = (split_strings[0], filetype)
...
if per_particle_analysis:
    for particle_id in particle_ids:
        ...
        for fnum, img in images.items():
            ...
            fz_residuals = processing.unrotate_and_crop_to_original_size(fz_residuals, rotate_degrees=0,
