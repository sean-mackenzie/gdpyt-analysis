...
padding_during_gdpyt_test_calib = 30
...
# experiment
path_name = join(base_dir, 'test_coords/tests')
save_id = 'exp_memb'
# meta-assessment
...
# file paths
test_dir = join(base_dir, 'test_coords/tests')
...
save_plots_tests, show_plots_tests = True, True

# test details
fps = ['test_id1_coords_large_pos.xlsx']  # ,
pressure = [1]
dfids = [1]

# filters
calib_lower_limit, calib_upper_limit = 90, 155
filter_cm = 0.9
filter_num_frames = 100
filter_z_std = 0.1
...
if analyze_test_data:
    ...
    for fp, _id in zip(fps, dfids):
        ...
        # filter
        df = df[df['z'] < calib_upper_limit - 0.1]  # NOTE: this calibration limit filter is important and needs more invest
