# spct meta-assessment - various "calibration" image sets
import os
...
Other datasets (results can be found on Box):
    ['20X_1Xmag_0.87umNR', '20X_1Xmag_2.15umNR_HighInt_0.03XHg', '10X_1Xmag_2.15umNR_HighInt_0.12XHg']
"""
...
# setup file paths
base_dir = '/Users/mackenzie/Desktop/gdpyt-characterization/calibration/analyses/spct-meta-for-diff-optics'
method = 'spct'
datasets = ['11.06.21_z-micrometer-v2']

for dataset in datasets:

    test_dir = join(base_dir, dataset)

    if dataset == '11.06.21_z-micrometer-v2':
        ...
        baseline_frame = 12  # NOTE: baseline frame was 'calib_13.tif' but IDPT output coords always begin at frame = 0.
        z_zero_from_calibration = 68.51
        frame_range = [5, 130]
        z_range = [frame_range[0] - z_zero_from_calibration, frame_range[1] - z_zero_from_calibration]
        z_inspect = [20, 40]  # note, this will include both: (-35, -10) and (10, 35)
        padding = 5

    elif dataset == '20X_1Xmag_0.87umNR':
        """ DoF = 4.7 microns """
        calib_id_from_calibset = 43
        calib_id_from_testset = 44
        ...
        baseline_frame = 17
        z_zero_from_calibration = 17.0
        frame_range = [1, 35]
        z_range = [-18, 18]
        z_inspect = [5, 14]  # note, this will include both: (-35, -10) and (10, 35)
        padding = 0

    elif dataset == '10X_1Xmag_2.15umNR_HighInt_0.12XHg':
        """ DoF = 12.0 microns """
        calib_id_from_calibset = 34
        calib_id_from_testset = 34
        ...
        baseline_frame = 75
        z_zero_from_calibration = 73.0
        frame_range = [1, 150]
        z_range = [-75, 75]
        z_inspect = [12, 22]  # note, this will include both: (-35, -10) and (10, 35)
        padding = 0

    elif dataset == '20X_1Xmag_2.15umNR_HighInt_0.03XHg':
        """ DoF = 4.7 microns """
        calib_id_from_calibset = 5
        calib_id_from_testset = 5
        ...
        baseline_frame = 35
        z_zero_from_calibration = 36.5
        frame_range = [1, 80]
        z_range = [-40, 40]
        z_inspect = [27, 29]  # note, this will include both: (-35, -10) and (10, 35)
        padding = 0
    ...
    path_results_combined = join(test_dir, 'results')
    ...
    print("Depth of field = {}".format(np.round(depth_of_field, 1)))
    num_pixels = 512
    ...
    # iterator
    param_zfs = ['zf_from_peak_int', 'zf_from_nsv', 'zf_from_nsv_signal']
    flips = [True, False]
    ...
    for param_zf in param_zfs:
        ...
        for flip_correction in flips:
            ...
            if analyze_test:
                ...
                #       1.b.i - make 'stack_id' for groupby and referencing
